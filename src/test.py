...
if __name__ == '__main__':
    ...
    if (choice == 'y'):
        ...
        start_webcam(loaded_model, window_size=(1200, 720), window_name=window_name, update_time=15)
    elif (choice == 'n'):
        run_loop = True
        window_name = "Facifier Static (press ESC to exit)"
        print("Default path is set to data/sample/")
        ...
        while run_loop:
            ...
            if file_name == "q" or file_name == "quit":
                ...
                if os.path.isfile(path):
                    analyze_picture(loaded_model, path, window_size=(1280, 720), window_name=window_name)
                else:
