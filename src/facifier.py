...
def analyze_picture(model_emotion, path, window_size, window_name='static'):
    ...
    for normalized_face, (x, y, w, h) in find_faces(image):
        ...
        cv2.putText(image, emotions[emotion_prediction[0]], (x,y-10), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
...
if __name__ == '__main__':
    ...
    if (choice == 'y'):
        ...
        start_webcam(fisher_face_emotion, window_size=(1200, 720), window_name=window_name, update_time=15)
    elif (choice == 'n'):
        run_loop = True
